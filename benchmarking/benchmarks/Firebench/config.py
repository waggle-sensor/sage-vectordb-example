"""FireBench-specific configuration/hyperparameters."""
...
class FireBenchConfig(Config):
    """Configuration for FireBench benchmark (fire science image retrieval)."""

    def __init__(self):
        """Initialize FireBench configuration."""
        # dataset parameters
        self.firebench_dataset = os.environ.get(
            "FIREBENCH_DATASET", "sagecontinuum/FireBench"
        )
        ...
        self._s3_prefix = os.environ.get("S3_PREFIX", "dev-metrics/firebench")
        ...
        self._collection_name = os.environ.get("COLLECTION_NAME", "FireBench")
