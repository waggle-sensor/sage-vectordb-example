...
hybrid_weight=0.5 #The weight of the hybrid search component in the unified score for hybrid colbert blend.
colbert_weight=0.5 #The weight of the colbert search component in the unified score for hybrid colbert blend.
hybrid_colbert_blend_top_k=10 #The number of top results to return from the hybrid colbert blend search.
